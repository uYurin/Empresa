# Empresa
Praticando a criação de uma empresa, utilizando BlueJ e linguagem Java

A empresa R2D2, possui diversos funcionarios, cada funcionario possui um nome, um cargo e seu Salario Base.
O calculo do Salario Liquido e:
...
A empresa precisa saber de:
Quanto gasta com o pagamento de todos os salarios
Imprima o nome do funcionario com Maior Salario.
Imprima o quanto a empresa gasta com quinquenio
